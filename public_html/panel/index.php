...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>USSTOKYO.com: Login </title>
...
<style>
body {
    /*background: url(assets/pages/img/login/audi.jpg) no-repeat;
    background-position: bottom;*/
    background-color: black;
   /* background-size: contain;*/
    width: 100%;
}
.col-md-6.login-container.bs-reset.mt-login-5-bsfix {
    ...
    <body class=" login">
        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-3 bs-reset mt-login-5-bsfix display-hideaa">
                    <div class="login-bg" style="">                     
                        <!--<h2 style="color:white; margin:0px; padding:0px;">USS TOKYO ADMIN PANEL</h2>-->
					</div>
                </div>
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content" style="margin-top: 10%;">
                        <h1>Welcome to USSTOKYO.com Login</h1>

                        <form action="<?php echo $_SERVER['PHP_SELF'];?>" class="login-form" method="post" style="margin-top: 20px;">
                                <br /><br /><br />
