<?php 
$page_name = 'perpetrator_groups';
$current_page = 'add_perp';
$table_name = 'perpetrator_groups';
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
										...
										<?php if(isset($_GET['edit'])){echo "Edit Perpetrator";}else{echo 'Add new Perpetrator';}?>
...
<input type="hidden" name="uid" <?php if(isset($_GET['edit'])){echo "value=".$row['id']."";}?>>	
                                            <div class="form-group  margin-top-20">
                                                <label class="control-label col-md-3">Perpetrator Name
	...
	<input type="text" class="form-control" name="name" <?php if(isset($_GET['edit'])){echo "value=".$row['name']."";}?> /> 
											...
											<div class="form-group">
                                                <label class="control-label col-md-3">Perpetrator Short Name
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                                    <div class="input-icon right">
	...
	<input type="text" class="form-control" name="short_name" <?php if(isset($_GET['edit'])){echo "value=".$row['short_name']."";}?> /> 
