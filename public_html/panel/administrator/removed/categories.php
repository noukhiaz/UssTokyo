...
<div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">Categories management</span>
                    <span class="caption-helper"> </span>
                </div>
                <div class="actions">
                    <!--<a href="index.php?p=add_categories">
...
<button class="btn btn-xs green dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> Actions
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="index.php?p=add_categories&id=<?php echo $row['id'];?>&edit=1">
