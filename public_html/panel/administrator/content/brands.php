...
<div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">Companies Brand management</span>
                    <span class="caption-helper"> </span>
                </div>
                <div class="actions">
                    <a href="index.php?p=add_brands">
...
<!-- <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">-->
 <table class="table table-striped table-hover table-bordered order-column" id="sample_3">
                                        <thead>
                                            <tr>
...
?>										
                                            <tr class="odd gradeX">
											   ...
											   <td>
<?php //echo $row['name'];
$comp_id = $row['parent_company'];
$sql_brands = mysql_query("SELECT * FROM companies where id = '$comp_id'");
$row_brands = mysql_fetch_assoc($sql_brands);
echo $row_brands['name'];
?> 
...
<button class="btn btn-xs green dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> Actions
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="index.php?p=add_brands&id=<?php echo $row['id'];?>&edit=1">
