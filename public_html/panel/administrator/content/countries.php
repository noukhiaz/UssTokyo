...
?>
 <div class="page-head">
            ...
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">Country management</span>
                    <span class="caption-helper"> </span>
                </div>
                <div class="actions">
                    <a href="index.php?p=add-country">
 ...
 <table class="table table-striped table-hover table-bordered" id="sample_3">
                                        <thead>
                                            <tr>
												...
												<th  style="text-align:center; width: 12px;"> Region </th>
...
<button class="btn btn-xs green dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> Actions
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="index.php?p=add-country&id=<?php echo $row['id'];?>&edit=1">
