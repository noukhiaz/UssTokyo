<?php 
$current_page = 'provinces';
$table_name = 'countries_province';
?>
 <div class="page-head">
                    <div class="row">
                        <div class="col-md-12">
...
<div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">Province management</span>
                    <span class="caption-helper"> </span>
                </div>
                <div class="actions">
                    <a href="index.php?p=country-province">
...
<button class="btn btn-xs green dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> Actions
                                                        ...
                                                        <ul class="dropdown-menu pull-left" role="menu">
                                                            <li>
                                                                <a href="index.php?p=country-province&id=<?php echo $row['id'];?>&edit=1">
