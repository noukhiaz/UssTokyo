...
<?php 
	...
	else
	{
		...
		//Putting sold water water mark on the car pic
		if($is_sold==1)
			{	
				$id = $_GET['id'];
				//echo "$id";
				$px_sql=mysql_query("SELECT * FROM car_pix where car_id='$id' and is_front='1'");
				$sql_px = mysql_fetch_assoc($px_sql);
				//echo $sql_px['pic_name'];
				//$stamp_path="../../uploads/Stamp.png";

				$path = "../../uploads/".$sql_px['pic_name'];
				//echo "$path";
				$stamp = imagecreatefrompng('../../panel/administrator/forms/Stamp.png');
				...
				$imgx = imagesx($im);
				$imgy = imagesy($im);
				$centerX=round($imgx/2)-130;
				$centerY=round($imgy/2)-110;
		...
		$success = '2';
		?>
<!--<img src="818Toyota Mark ll - UssTokyo.com.jpg" class="img-responsive" width="10" height="1"  />	
<meta http-equiv="refresh" content="0;URL='index.php?p=<?php echo $page_name;?>'" />
-->
<?php 
	}
...
<i class="fa"></i><!-- onchange="showCat(this.value)"-->
...
<div id="txtHint">
    ...
    <label class="control-label col-md-4">Car Name <span class="required"> * </span></label>
        <div class="col-md-8">
            <div class="input-icon right">
            <i class="fa"></i>
			<input type="text" class="form-control" name="brands_id" <?php if(isset($_GET['edit'])){?> value="<?php echo $row['brands_id'];}?>" />
...
<div class="form-group">
<label class="control-label col-md-4">Auction Grade
 <span class="required"> * </span>
</label>
<div class="col-md-8">
 <div class="input-icon right">
