...
$result = mysql_query("SELECT * FROM $table_name where id = '$chasis'");
$num_rows = mysql_num_rows($result);
	...
	/*mysql_query("INSERT INTO winingcars set `lotn` = '$lotn', `bid_id` = '$bid_id', `user_id` = '$user_id', `freight_chrgs` = '$freight_chrgs', `comssion` = '$comssion', 
	`inspection` = '$inspection', `vanning` = '$vanning', `status` = '$status', `start_price` = '$start_price', `currency_rate` = '$currency_rate', 
	`auction_country` = '$auction_country', `destination_country` = '$destination_country', 	`name` = '$name', `make` = '$make', `auction_time` = '$auction_time', 
	`auction_house` = 'asd', `packag` = 'asd', `grade` = '3', `fuel` = 'as', `trans` = 'asd', 
	`equipment` = 'asd', `yard` = 'asd', `chasis` = 'asd', `mileage` = 'asd', `displace` = 'asd', `conde` = 'asd', `condi` = 'asd', `colorr` = 'a', 
	`price` = '32', `short_descip` = 'asd', `is_active` = '1', 
	`is_auction` = '1', `year` = '2344', `reg_date` = '324234'")	;
	*/
...
//	            if(move_uploaded_file($_FILES["files"]["tmp_name"][$f], $path.$pic_name))				
				...
				mysql_query("INSERT into car_pix (`reg_date`,`car_id`,`pic_name`) VALUES('$reg_date','$car_id','$new_file_name')");
...
<input type="hidden" name="car_id" value="<?php echo $row['car_id'];?>"  class="form-control" />
<input type="hidden" name="bid_id" value="<?php echo $row['id'];?>"  class="form-control" />
...
<i class="fa"></i>
<input type="text" name="freight_chrgs" <?php if(isset($_GET['edit'])){echo "value=".$row['freight_chrgs']."";}?>  class="form-control" />
</div>
</div>
</div> 
...
<div class="col-md-8">
 <div class="input-icon right">
<i class="fa"></i>
<input type="text" name="comssion" <?php if(isset($_GET['edit'])){echo "value=".$row['comssion']."";}?>  class="form-control" />
</div>
</div>
</div> 
...
<div class="col-md-8">
 <div class="input-icon right">
<i class="fa"></i>
<input type="text" name="inspection" <?php if(isset($_GET['edit'])){echo "value=".$row['inspection']."";}?>  class="form-control" />
</div>
</div>
</div>
...
<div class="col-md-8">
 <div class="input-icon right">
<i class="fa"></i>
<input type="text" name="vanning" <?php if(isset($_GET['edit'])){echo "value=".$row['vanning']."";}?>  class="form-control" />
</div>
</div>
</div>
