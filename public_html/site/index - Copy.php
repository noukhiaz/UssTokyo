...
<![endif]-->
<div class="body" style="padding-top: 176px;"><?php include('inc_header.php');?></div>
    <div class="hero-area">
        <!-- Start Hero Slider -->
...
<!--				<li class="parallax" style="background-image:url(images/LC_.png);"></li>-->
    ...
    <!-- Start Body Content -->
  	<div class="main" role="main">
    	<div id="content" class="content full padding-b0">
            <div class="container">
            	...
            	<div class="row">
                	<div class="col-md-12 text-align-center">
                    	<h1 class="uppercase strong">WELCOME TO THE USSTOKYO.COM</h1>
                        
                	<p class="lead">We are here as a bridge between the customers from all over the world and the Japanese Car Auctions. We are here to make it as easy for you to buy your dream car from Japan as you buy something from a store near you.  </p>
					<p class="lead">We will take care of all steps, like buying from auctions, shipping and delivering your dream car to your doorstep.
            ...
            <div class="lgray-bg make-slider"  style="background:url(images/pattern-mobile.png) repeat;     border-top: 1px solid rgba(0,0,0,.05);">
            	<div class="container">
                    <!-- Search by make -->
                    <div class="row">
