...
<li class="button red "><a href="invoice<?php echo $phpext;?>?iid=<?php echo $row['id'];?>"  style="color:#FFFFFF;" onClick="javascript:void window.open('invoice<?php echo $phpext;?>?iid=<?php echo $row['id'];?>','1526892559135','width=1024,height=650,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1,left=0,top=0');return false;"><i class="fa fa-file-pdf-o"></i> Invoice</a></li>
...
<li class="button red "><a href="docs<?php echo $phpext;?>?did=<?php echo $row['id'];?>&type=auction_sheet"  style="color:#FFFFFF;" onClick="javascript:void window.open('docs<?php echo $phpext;?>?did=<?php echo $row['id'];?>&type=auction_sheet','1526892559135','width=1024,height=650,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1,left=0,top=0');return false;"><i class="fa fa-file-pdf-o"></i> Auction Sheet</a></li>
<?php }if($rowss_doc['export_cert'] == ''){echo '';}else{?>
<li class="button red "><a href="docs<?php echo $phpext;?>?did=<?php echo $row['id'];?>&type=export_cert"  style="color:#FFFFFF;" onClick="javascript:void window.open('docs<?php echo $phpext;?>?did=<?php echo $row['id'];?>&type=export_cert','1526892559135','width=1024,height=650,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1,left=0,top=0');return false;"><i class="fa fa-file-pdf-o"></i> Export Certificate</a></li>
<?php }if($rowss_doc['bl'] == ''){echo '';}else{?>
<li class="button red "><a href="docs<?php echo $phpext;?>?did=<?php echo $row['id'];?>&type=export_cert"  style="color:#FFFFFF;" onClick="javascript:void window.open('docs<?php echo $phpext;?>?did=<?php echo $row['id'];?>&type=bl','1526892559135','width=1024,height=650,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1,left=0,top=0');return false;"><i class="fa fa-file"></i> Bill of Lading</a></li>
<?php }?>

<li class="button red "><a href="car_images<?php echo $phpext;?>"  style="color:#FFFFFF;" onClick="javascript:void window.open('car_images<?php echo $phpext;?>?did=<?php echo $row['id'];?>&id=zAh4lLgazenwB4&col=0','1526892559135','width=1024,height=650,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1,left=0,top=0');return false;"><i class="fa fa-photo"></i> Pictures</a></li>


<?php
$sql_pix = mysql_query("select * from car_pix where car_id = '$car_id' AND is_yard = '1' ");
$rowss_pix = mysql_fetch_assoc($sql_pix);
if($rowss_pix['id'] == ''){echo '';}else{
?>
<li class="button red "><a href="car_images_yard<?php echo $phpext;?>"  style="color:#FFFFFF;" onClick="javascript:void window.open('car_images_yard<?php echo $phpext;?>?did=<?php echo $row['id'];?>&id=zAh4lLgazenwB4&col=0','1526892559135','width=1024,height=650,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1,left=0,top=0');return false;"><i class="fa fa-photo"></i> Yard Pictures</a></li>
...
<?php if($total_purchased == '0'){echo 'Sorry, no vehicles purchased yet.';} else{?>
                     <ul class="pagination">
<?php
/*not editable Asad */
