             ...
             //     $year_to = $_REQUEST['year_to'];
...

               {
...

                  {
                    ...
                    $WHERE[] = "MILEAGE BETWEEN '$mileage_to' AND '$mileage_from'";
                           ...
                           <div class="car-image">
                              ...
                              <div class="car-overlay-banner">
                                 ...
                                 <ul>
                                    ...
                                    <li><a href="car_detail_auction.php?id=<?php echo $va['ID'];?>&col=<?php echo $col;?>"><i class="fa fa-link"></i></a></li>
...
<th style="width: 100px;">Result &yen;</th
               ...
               <tbody>
                  ...
                  <td style="text-align:center;"><a href="car_detail_auction.php?id=<?php echo $va['ID'];?>&col=<?php echo $col;?>">
                  ...
                  <td style="width: 78px;"><a href="car_detail_auction.php?id=<?php echo $va['ID'];?>&col=<?php echo $col;?>">
