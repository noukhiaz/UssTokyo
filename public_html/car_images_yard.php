...
<title>www.USSTokyo.com: Car Yard Images</title>
								...
								<div class="row">
									<div class="slider-slick">
									  <div class="slider slider-for detail-big-car-gallery"> 
											<?php
											$id = $_GET['did'];
											$sql = mysql_query("select * from car_pix where car_id = '$id' AND is_yard = '1' order by id asc");
										...
										<div class="slider slider-nav"> 
											<?php  $sqla = mysql_query("select * from car_pix where car_id = '$id' AND is_yard = '1'  order by id asc");
