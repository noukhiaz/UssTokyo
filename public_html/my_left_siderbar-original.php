...
<!--	<li><a href="myaccount.php" class="active"><i class="fa fa-angle-right" style="padding-left:20px;"></i> Dashboard </a></li>-->
	<li><a href="my_bids.php?date=<?php echo date('Y-m-d',time());?>"><i class="fa fa-angle-right" style="padding-left:20px;"></i> My Bids </a></li>
<!--	<li><a href="my_fav.php"><i class="fa fa-angle-right" style="padding-left:20px;"></i> My Favourites</a></li>-->
<!--	<li><a href="my_finance.php"><i class="fa fa-angle-right" style="padding-left:20px;"></i> Finance History</a></li>
	...
	<?php }?>
	-->
<li><a href="my_purchasing.php"><i class="fa fa-angle-right" style="padding-left:20px;"></i> Purchase History</a></li>
	
	
	<li><a href="my_profile.php"><i class="fa fa-angle-right" style="padding-left:20px;"></i> My Profile</a></li>
	<li><a href="my_password.php"><i class="fa fa-angle-right" style="padding-left:20px;"></i> Change Password</a></li>
	<li><a href="logout.php"><i class="fa fa-angle-right" style="padding-left:20px;"></i> Logout</a></li>
	</ul>
</div>