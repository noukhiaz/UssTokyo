	...
	<div class="mailster-setup-steps">
		...
		<div class="mailster-setup-step" id="step_delivery">
			...
			<div id="deliverynav" class="nav-tab-wrapper hide-if-no-js">
				<a class="nav-tab<?php if ( 'simple' == $method ) {	echo ' nav-tab-active'; } ?>" href="#simple"><?php esc_html_e( 'Simple', 'mailster' ) ?></a>
				...
				<a class="nav-tab<?php if ( 'mailgun' == $method ) {echo ' nav-tab-active'; } ?>" href="#mailgun">Mailgun</a>
			...
			<div class="deliverytab" id="deliverytab-simple" <?php if ( 'simple' == $method ) {	echo 'style="display:block"'; } ?>>
				<?php do_action( 'mailster_deliverymethod_tab_simple' ); ?>
			</div>
			<div class="deliverytab" id="deliverytab-gmail" <?php if ( 'gmail' == $method ) {	echo 'style="display:block"'; } ?>>
				<?php do_action( 'mailster_deliverymethod_tab_gmail' ); ?>
			</div>
			<div class="deliverytab" id="deliverytab-smtp" <?php if ( 'smtp' == $method ) {	echo 'style="display:block"'; } ?>>
				<?php do_action( 'mailster_deliverymethod_tab_smtp' ); ?>
			</div>
			<div class="deliverytab" id="deliverytab-amazonses" <?php if ( 'amazonses' == $method ) { echo 'style="display:block"'; } ?>>
				<?php if ( in_array( 'mailster-amazonses', $active_pluginslugs ) ) :
			...
			<div class="deliverytab" id="deliverytab-mailgun" <?php if ( 'mailgun' == $method ) { echo 'style="display:block"'; } ?>>
				<?php if ( in_array( 'mailster-mailgun', $active_pluginslugs ) ) :
			...
			<div class="deliverytab" id="deliverytab-sendgrid" <?php if ( 'sendgrid' == $method ) {	echo 'style="display:block"'; } ?>>
				<?php if ( in_array( 'mailster-sendgrid', $active_pluginslugs ) ) :
			...
			<div class="deliverytab" id="deliverytab-mandrill" <?php if ( 'mandrill' == $method ) {	echo 'style="display:block"'; } ?>>
				<?php if ( in_array( 'mailster-mandrill', $active_pluginslugs ) ) :
			...
			<div class="deliverytab" id="deliverytab-dummymailer" <?php if ( 'dummymailer' == $method ) { echo 'style="display:block"'; } ?>>
