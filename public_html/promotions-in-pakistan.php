...
<title>www.USSTokyo.com: Packages in Pakistan</title>
     ...
     <div class="row text-center intro-title">
           ...
           <div class="col-lg-6 col-md-6 col-sm-6 text-right">
             ...
             <ul class="page-breadcrumb">
                ...
                <li><span>Promotions in Pakistan</span> </li>
    ...
    <div class="row">
      ...
      <div class="col-md-offset-1 col-md-10">
         ...
         <div class="section-title">
           ...
           <h2>Packages in Pakistan ~ USSTOKYO.COM</h2>

           <div class="separator"></div>

          
          <center>
               <img src="packages-pakistan.png" alt="USSTOKYO.com" />
