...
<div class="col-lg-12 col-md-12 col-sm-12">
	<div class="row">
		...
		<a href="my_bids.php?date=<?php echo date('Y-m-d',time());?>">My Favourites</a>
		</div>
...
<div class="col-lg-3 col-md-3 bg_contnainer">
	<div class="form-group">
		...
		<div class="cont_field" style="margin-bottom:10px;">
		<h4 class="cont_title">DISPLANCE: </h4>  
		...
		<div class="cont_field" style="margin-bottom:10px;">
			<input id="submit" name="submit" type="submit" style="width:100%; padding-bottom:20px; padding-top:20px;" value="SEARCH" class="button red">
			<br />&nbsp;
